...
class MoviesListHeaderView: UICollectionReusableView {
    // MARK: - Properties
    static let reuseIdentifier = "MoviesListHeaderView"
    
    // MARK: - Views
    let titleLabelView: UILabel = {
        let view = UILabel()
        view.text = String(localized: "Movies")
...
// MARK: - View Code
extension MoviesListHeaderView: ViewCode {
    func addSubviews() {
