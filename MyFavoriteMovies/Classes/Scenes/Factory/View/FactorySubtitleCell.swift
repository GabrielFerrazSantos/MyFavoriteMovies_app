...
class FactorySubtitleCell: UITableViewCell {
    // MARK: - Properties
    static let reuseIdentifier = "FactorySubtitleCell"
...
// MARK: - View Code
extension FactorySubtitleCell: ViewCode {
    func addSubviews() {
...
// MARK: - Extension
extension FactorySubtitleCell {
    func setupCell(with subtitle: String) {
